    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <x-card title="Informasi Data Diri">
                <form action="{{ route('profil.update') }}" method="POST" x-data="{ loading: false }" @submit="loading = true">
                    @csrf @method('PUT')
            ...
            <x-card title="Keamanan Kata Sandi (Password)">
                <form action="{{ route('profil.updatePassword') }}" method="POST" x-data="{ loading: false }" @submit="loading = true">
                    @csrf @method('PUT')
